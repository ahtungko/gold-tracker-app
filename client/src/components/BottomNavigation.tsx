          ...
          return (
            <li key={item.path} className="flex flex-1">
              ...
              >
                <div
                  className={cn(
                    "relative flex w-full flex-col items-center justify-center gap-1.5 rounded-2xl px-2 py-2 text-xs font-medium transition-colors",
                ...
                >
                  <span
                    aria-hidden="true"
                    className={cn(
                      "pointer-events-none absolute inset-x-1.5 inset-y-1 -z-10 rounded-2xl bg-primary/12",
                      prefersReducedMotion
                        ? "transition-none"
